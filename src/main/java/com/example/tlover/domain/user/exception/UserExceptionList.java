...
public enum UserExceptionList {
    ...
    NOT_FOUND_USER("U0002", HttpStatus.BAD_REQUEST, "해당 아이디를 찾을 수 없습니다."),
    ...
    NOT_CERTIFIED("U0007", HttpStatus.BAD_REQUEST, "인증 코드가 일치하지 않습니다."),
    ...
    USER_DELETED("U0010", HttpStatus.BAD_REQUEST, "해당 계정은 삭제된 계정입니다."),
    USER_EMAIL_DUPLICATE("U0011", HttpStatus.CONFLICT, "해당 이메일은 이미 존재하는 이메일입니다.");
